...
const APIUrl = 'https://contoso-traders-productsprod.azurewebsites.net/v1';
const APIUrlShoppingCart = 'https://contoso-traders-cartsprod.delightfuldune-ced90d47.eastus.azurecontainerapps.io/v1';
